...
const { Employee, Permission, Task, LeaveType, LeaveRequest, Attendance, PayrollReport, SalarySlip, SalaryComponent, EmployeeSalaryStructure, Message  } = sequelize.models;
